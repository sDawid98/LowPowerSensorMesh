...
{
  /* TemperatureData */
  CUSTOM_STM_TEMPERATUREDATA_READ_EVT,
  CUSTOM_STM_TEMPERATUREDATA_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_TEMPERATUREDATA_NOTIFY_DISABLED_EVT,
  /* WibrationData */
  CUSTOM_STM_WIBRATIONDATA_READ_EVT,
  CUSTOM_STM_WIBRATIONDATA_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_WIBRATIONDATA_NOTIFY_DISABLED_EVT,
